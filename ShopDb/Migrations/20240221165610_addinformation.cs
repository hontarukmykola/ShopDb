        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    quantiti = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Name", "Price", "discount", "isInStock", "quantiti" },
                values: new object[,]
                {
                    { 1, 1, "Milk", 40m, 5f, false, 28 },
                    { 2, 2, "Bread", 30m, 2f, false, 34 },
                    { 3, 3, "apple", 70m, 6f, false, 64 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Soborna26", 1, "ATB", 1 },
                    { 2, "StevanaBanderu4", 2, "Epicentr", 2 },
                    { 3, "cuntralna7", 3, "Ikea", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "David@email.com", "Daivd", "12345678", 1, 12000m, 1, "Ivanov" },
                    { 2, "Ivan@email.com", "Ivan", "75462746", 2, 9000m, 2, "Bondarenko" },
                    { 3, "Vitya@email.com", "Vitya", "26584731", 3, 11000m, 3, "Ivanenko" }
                });
